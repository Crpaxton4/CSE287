...
void buildScene() {
	...
	std::shared_ptr<Sphere> greenBall = std::make_shared<Sphere>(glm::vec3(0.0f, 0.7f, -11.0f), 1.5f, color(0.0f, 1.0f, 0.0f, 1.0f));
	std::shared_ptr<Plane> plane = std::make_shared<Plane>(glm::vec3(0.0f, -1.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f), color(1.0f, 1.0f, 0.0f, 1.0f));
