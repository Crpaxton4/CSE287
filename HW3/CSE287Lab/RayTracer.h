...
public:
	...
	*/
	void raytraceScene(const std::vector<std::shared_ptr<Surface>>& surfaces, const std::vector<std::shared_ptr<PositionalLight>>& lights, const int & antiAlias);
...
protected:
	...
	*/
	...
	bool traceShadowFeeler(const glm::vec3 & intersectionPt, const std::shared_ptr<PositionalLight> light);
	...
	*/
	...
	std::vector<std::shared_ptr<PositionalLight>> lightsInScene;
